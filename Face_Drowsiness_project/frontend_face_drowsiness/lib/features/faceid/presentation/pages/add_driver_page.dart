...
import '../../../drowsiness/presentation/pages/home_page.dart';
...
class _AddDriverPageState extends State<AddDriverPage>
  ...
  Future<void> handleBurstEnroll() async {
    ...
    try {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(content: Text("$message | saved: $savedCount")),
      );
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(content: Text("Burst capture failed: $e")),
      );
    } finally {
      _countdownTimer?.cancel();
  ...
  Widget build(BuildContext context) {
    ...
    final double shownProgress =
        isCapturing ? _progressController.value : 0.0;
            ...
            AnimatedBuilder(
              ...
              builder: (context, _) {
                return CameraScanFrame(
                  ...
                  width: 300,
                  height: 300,
                  child: LiveCameraWebView(
                    url: FaceIdApi.cameraFeedUrl,
                    width: 280,
                    height: 280,
                  ),
                );
