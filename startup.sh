...
# Decorative themes use the display-synchronised 60 Hz clock. Set a lower
# value explicitly only for software-renderer or thermal diagnostics.
AMBIENT_MOTION_FPS="${AMBIENT_MOTION_FPS:-60}"
