...
class LyricsService {
  ...
  /// CACHE
  final Map<String,
      List<LyricLine>> _cache = {};

  /// =========================
  /// GET LYRICS
  /// =========================
  Future<List<LyricLine>>
      getLyrics({
  ...
  List<LyricLine> _parsePlainLyrics(
    String plainLyrics,
  ) {
    return plainLyrics
        .split('\n')
